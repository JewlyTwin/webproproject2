...
/*            .bgcolor {
    ...
    <body class="bgcolor">
        ...
        <form action="EditProfile" method="post">
            <input type="text" name="username" value="${cus.username}" class="fadeIn second"disabled/><br>
            <input type="password" name="pass" value="${cus.password}"class="fadeIn second" placeholder="password"required/><br>
            <input type="text" name="fname" value="${cus.fname}" class="fadeIn second"placeholder="first name"required><br>
